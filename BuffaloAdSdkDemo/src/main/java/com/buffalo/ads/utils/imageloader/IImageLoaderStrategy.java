...
/**
 * ================================================
 * 图片加载策略,实现 {@link IImageLoaderStrategy}
 * 并通过 {@link GlideImageLoader#setLoadImgStrategy(IImageLoaderStrategy)} 配置后,才可进行图片请求
 * <p>
 ...
 * ================================================
 */
public interface IImageLoaderStrategy<T extends GlideImageConfig> {
