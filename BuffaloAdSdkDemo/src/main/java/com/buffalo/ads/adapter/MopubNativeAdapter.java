...
//    }
//
//    private class MopubNativeAd extends BaseNativeAd implements MoPubNative.MoPubNativeNetworkListener {
...
//            MopubS
//            mNativeResponse = nativeAd;
//            nativeAd.getBaseNativeAd().
//            setTitle(nativeAd.getTitle());
//            setAdBody(nativeAd.getText());
//            setAdCallToAction(nativeAd.getCallToAction());
//            setAdCoverImageUrl(nativeAd.getMainImageUrl());
//            setAdIconUrl(nativeAd.getIconImageUrl());
//            String starRating = nativeAd.getStarRating() + "";
