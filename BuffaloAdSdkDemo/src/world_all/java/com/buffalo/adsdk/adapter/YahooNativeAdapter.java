...
public class YahooNativeAdapter extends NativeloaderAdapter {
    ...
    public boolean extrasAreValid(Map<String, Object> extras) {
        if (extras != null && extras.containsKey(NativeAd.KEY_PLACEMENT_ID)) {
            String object = (String) extras.get(NativeAd.KEY_PLACEMENT_ID);
    ...
    private class YahooNativeAd extends BaseNativeAd implements FlurryAdNativeListener {
