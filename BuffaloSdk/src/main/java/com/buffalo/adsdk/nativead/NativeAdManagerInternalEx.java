...
public class NativeAdManagerInternalEx extends NativeAdManagerInternal {
    ...
    private boolean preloadNativeAdImage(final ImageINativeAd imageINativeAd) {
        ...
        if (NativeAdManagerFactory.getImageDownloadListener() != null) {
            NativeAdManagerFactory.getImageDownloadListener().getBitmap(imageINativeAd.getAdObject().getAdIconUrl(), false, null);
            NativeAdManagerFactory.getImageDownloadListener().getBitmap(imageINativeAd.getAdObject().getAdCoverImageUrl(), false, new BitmapListener() {
                @Override
