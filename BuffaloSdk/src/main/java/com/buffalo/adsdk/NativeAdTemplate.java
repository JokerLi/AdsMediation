...
public class NativeAdTemplate {
    ...
    public static class ViewHolder {
        ...
        private NativeAdTemplate mViewBinder;
        ...
        public ViewHolder(Context context, NativeAdTemplate viewBinder) {
            mContext = context;
    ...
    public static class Builder {
        ...
        public final NativeAdTemplate build() {
