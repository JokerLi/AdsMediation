...
public class MobvistaNativeAdapter extends NativeloaderAdapter {
    ...
    public void loadNativeAd(@NonNull Context context, @NonNull Map<String, Object> extras) {
        mContext = context;
        mPlacementId = (String)extras.get(CMBaseNativeAd.KEY_PLACEMENT_ID);
        mLoadSize = (Integer)extras.get(CMBaseNativeAd.KEY_LOAD_SIZE);
    ...
    private class MobvistaNativeAd extends CMBaseNativeAd implements NativeAdListener {
        Campaign mCampaign;
