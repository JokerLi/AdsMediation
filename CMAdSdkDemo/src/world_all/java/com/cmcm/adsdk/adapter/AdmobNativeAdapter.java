...
public class AdmobNativeAdapter extends NativeloaderAdapter {
    ...
    private class AdmobNativeAd extends CMBaseNativeAd implements
        ...
        public void loadAd(){
            ...
            if(mExtras.containsKey(CMBaseNativeAd.KEY_FILTER_ADMOB_INSTALL_AD)){
                filterInstallAd = (boolean) mExtras.get(CMBaseNativeAd.KEY_FILTER_ADMOB_INSTALL_AD);
            }
            boolean filterContentAd = false;
            if(mExtras.containsKey(CMBaseNativeAd.KEY_FILTER_ADMOB_CONTENT_AD)){
                filterContentAd = (boolean) mExtras.get(CMBaseNativeAd.KEY_FILTER_ADMOB_CONTENT_AD);
            }
