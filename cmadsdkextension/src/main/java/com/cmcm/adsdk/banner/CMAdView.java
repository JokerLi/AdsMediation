...
public class CMAdView extends FrameLayout{
    ...
    public CMAdView(Context context, String posid, CMBannerAdSize size) {
        super(context);
        this.posid = posid;
        this.adSize = size;
    ...
    class MyBannerViewLoadListener implements INativeAdLoaderListener {
        ...
        public void adClicked(INativeAd nativeAd) {
            ...
            if(mBannerAdListener != null) {
                mBannerAdListener.onAdClicked(CMAdView.this);
            }
        }
    }
    ...
    private void notifyLoaded() {
        if(managerRequest != null){
            ...
            if(obj != null && obj instanceof View){
                ...
                CMAdView.this.addView((View)obj);
                if(mBannerAdListener != null) {
                    mBannerAdListener.onAdLoaded(CMAdView.this);
                    return;
                }
            }
        }
    ...
    private void notifyFailed(final int errorCode) {
        if(mBannerAdListener != null) {
            mBannerAdListener.adFailedToLoad(CMAdView.this, errorCode);
        }
    }
