...
import com.cmcm.adsdk.utils.DownloadCheckDialog;
...
import com.cmcm.utils.ViewShowReporter;
 ...
 */
public class CMNativeAd extends CMBaseNativeAd implements
        View.OnClickListener, View.OnTouchListener, ImpressionListener, INativeAd.IAdOnClickListener, Comparable<CMNativeAd> {
...
//        this.mHasReportClick = false;
    ...
    public CMNativeAd(Context context, IAdOnClickListener adClickListener,
                      Map<String, Object> extras, CMBaseNativeAd ad) {
        super();
        mContext = context;
        mAd = ad;
...
//        }
    ...
    public void onClick(View view) {
        ...
        if(isNeedExecuteClick){
            boolean checkDownload = CMAdManager.sIsCnVersion && mAd.isDownLoadApp();
            if(checkDownload){
...
//    //For report
    ...
    @Override
    public int compareTo(CMNativeAd another) {
        if(null != another){
